...
window.qBittorrent.ContextMenu ??= (() => {
    ...
    class TorrentsTableContextMenu extends ContextMenu {
        ...
        updateCategoriesSubMenu(categories) {
            ...
            contextCategoryFragment.append(
                createMenuItem("QBT_TR(New...)QBT_TR[CONTEXT=TransferListWidget]", "images/list-add.svg", torrentNewCategoryFN),
                createMenuItem("QBT_TR(Reset)QBT_TR[CONTEXT=TransferListWidget]", "images/edit-clear.svg", () => { torrentSetCategoryFN(""); })
            );
            ...
            document.getElementById("contextCategoryList").replaceChildren(contextCategoryFragment);
        }
        ...
        updateTagsSubMenu(tags) {
            ...
            contextTagFragment.append(
                createMenuItem("QBT_TR(Add...)QBT_TR[CONTEXT=TransferListWidget]", "images/list-add.svg", torrentAddTagsFN),
                createMenuItem("QBT_TR(Remove All)QBT_TR[CONTEXT=TransferListWidget]", "images/edit-clear.svg", torrentRemoveAllTagsFN)
            );
            ...
            document.getElementById("contextTagList").replaceChildren(contextTagFragment);
        }
    };
